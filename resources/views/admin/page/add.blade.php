        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 align-items-center">
                    <div class="card">
                        <form method="post" enctype="multipart/form-data" action="{{route('admin.page.store')}}">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="content" id="page_body" class="form-control demo" data-position="bottom left" ></textarea>
                                </div>
