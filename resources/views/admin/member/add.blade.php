        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 align-items-center">
                    <div class="card">
                        <form method="post" enctype="multipart/form-data" action="{{route('admin.member.store')}}">
                            @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="hue-demo" name="name" class="form-control demo" data-control="hue" >
                            </div><div class="form-group">
                                <label for="hue-demo">email</label>
                                <input type="email" id="hue-demo" name="email" class="form-control demo" data-control="hue" >
                            </div><div class="form-group">
                                <label for="hue-demo">phone</label>
                                <input type="text" id="hue-demo" name="phone" class="form-control demo" data-control="hue" >
                            </div>
                            <div class="form-group">
                                <label class="hue-demo"> Select Designation</label>
